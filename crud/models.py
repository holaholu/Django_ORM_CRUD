...
# Instructor model
class Instructor(User): # User is the parent class. means relationship is one to one
...
class Lesson(models.Model):
    ...
    course = models.ForeignKey(Course, null=True, on_delete=models.CASCADE) #one to many
